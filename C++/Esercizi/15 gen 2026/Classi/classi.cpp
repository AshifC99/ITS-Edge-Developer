...
int main()
{
    ...
    Quadrato tavolino;
    float c; // variabile che rappresenta il lato del tavolino

    int d = rand() % 5 + 1;
    c = d; // lato del tavolino tra 1 e 5

    tavolino.assegna(c);

    cout << "Perimetro del tavolino: " << tavolino.perimetro() << endl;
    cout << "Area del tavolino: " << tavolino.area() << endl;
    cout << "Diagonale del tavolino: " << tavolino.diagonale() << endl;
    cout << "Volume del cubo con lato uguale al tavolino: " << tavolino.volumeCubo() << endl;
